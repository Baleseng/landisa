  ...
  <div class="article-sidebar sticky-div-news">
  	<div class="article-results-container">
			    ...
			    <div slot="input">
			      <div class="post_input">
			        <form method="POST" action="{{ url('/post') }}">
			          ...
			          <input type="hidden" value="{{ $content->id }}" name="news_id"/>
			          <input type="hidden" value="{{ $content->section }}" name="section"/>
			          <input type="hidden" value="{{ $content->article_img }}" name="article_img"/>
			          ...
			          <input type="hidden" value="{{ $content->section }}" name="postsection"/> 
			    ...
			    <div slot="sticky">
			      <div class="post_col">
			        <div class="post_col_img">
			          <img src="https://writer.triwink.app/images/articles/{{$content->article_img}}">
			        </div>
			        <div class="post_col_title">
			          <i class="fa fa-{{ $content->section }}"></i>
			          <h3>{{ $content->title }}</h3>  
		    ...
		    <div class="article-results-btn">
			  ...
			  <div class="article-results-btn">
		    	<span class="result-btn"><i class="fa fa-eye"></i> <b>{{ views($content)->unique()->count() }}</b></span>
		    </div>
