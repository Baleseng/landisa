...
@section('title',' ' .$url. ' | Media | Review')
          ...
          <div class="admin-wrap-article">
            ...
            @foreach ($id as $media)
              <div class="table_row row">
                ...
                <div class="table_img">
                  <a href="{{ url($url.'/media/upload/'. $media->id . '-' . str_replace(' ', '-', $media->title)) }}">
                ...
                <div class="dropdown2">
                  ...
                  <div id="m5" class="dropdown2-content">
                    ...
                    <div class="index-btn-row">
                      <a href="{{ url($url.'/media/preview/'. $media->id . '-' . str_replace(' ', '-', $media->title)) }}">
                        <i class="fa fa-eye"></i> Preview
                      </a>
                    </div>

                    <div class="index-btn-row">
                      <a href="{{ url($url.'/media/timeline/'. $media->id . '-' . str_replace(' ', '-', $media->title)) }}">
