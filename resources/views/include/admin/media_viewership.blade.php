  ...
  <div class="admin-dashboard-col-3">
    ...
    <div class="admin-dashboard-col-3">
      <div class="admin-scroll-article" id="scroll-y">
        @foreach ($viewsm as $view)
          <div class="table_row row">

            <div class="table_flags">
              <img src="https://cms.mqoqowa.africa//images/africa/{{ $view->flag }}.svg" />
            </div>

            <div class="table_img">
              <a href="{{ url($url.'/media/upload/'. $view->id . '-' . str_replace(' ', '-', $view->title)) }}">
            ...
            <div class="dropdown2">
              ...
              <div id="m5" class="dropdown2-content">
                ...
                <div class="index-btn-row">
                  <a href="{{ url($url.'/media/preview/'. $view->id . '-' . str_replace(' ', '-', $view->title)) }}">
                    <i class="fa fa-eye"></i> Preview
                  </a>
                </div>

                <div class="index-btn-row">
                  <a href="{{ url($url.'/media/dashboard/'. $view->id . '-' . str_replace(' ', '-', $view->title)) }}">
                ...
                @include('include.admin.media_viewership_btn_'.$url)
