...
class GearheadController extends Controller{
  ...
  */
  ...
  public function index(){
    ...
    return view('gearhead.index', compact(
      'user',
      'news',
      'content',
      'geoip',
  ...
  public function news(News $id, Comment $pageId){
    ...
    return view('gearhead.news', ['pageId' => $pageId], compact(
      'user',
      'id',
      'writer',
      'related',
